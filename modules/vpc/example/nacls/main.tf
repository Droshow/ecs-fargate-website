...
module "vpc" {
  ...
  nacl_disable_creation       = false
  nacl_disable_default_ruless = false # disable defaults implies no default NACLs are deployed
  nacl_rules_public = {
    100 = { port = "0", action = "Allow", protocol = "all", type = "ingress", cidr_block_4 = "0.0.0.0/0" }
    101 = { port = "0", action = "Allow", protocol = "all", type = "egress", cidr_block_6 = "::/0" }
  }

  nacl_rules_egress_only = {
    100 = { port = "0", action = "Allow", protocol = "all", type = "ingress" }
    101 = { port = "0", action = "Allow", protocol = "all", type = "egress" }
  }
